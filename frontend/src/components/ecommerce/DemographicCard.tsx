...
export default function DemographicCard() {
  ...
  return (
    <div className="rounded-2xl border border-[#e7ded0] bg-[#fffdfa]/95 p-5 shadow-[0_20px_40px_-34px_rgba(28,25,23,0.28)] dark:border-[#273244] dark:bg-[#0f172a]/70 sm:p-6">
