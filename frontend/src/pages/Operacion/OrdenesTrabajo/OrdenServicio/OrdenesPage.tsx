        ...
        <header className={`relative flex w-full flex-col gap-4 ${cardShellClass} p-4 sm:p-6`}>
          ...
          <div className="relative z-[1] flex min-w-0 gap-3 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h1 className={`mt-0.5 ${claudeHeroHeadingClass}`}>Órdenes de trabajo</h1>
              <p className={`mt-1 max-w-2xl ${claudeBodyClass}`}>
                Administra órdenes de servicio, firmas y PDF. Filtra por estado, servicio o fecha en el listado.
              </p>
          ...
          <div className="p-2 pt-0">
            ...
            <div className="hidden overflow-x-auto rounded-xl border border-[#e7ded0]/90 bg-[#fcfaf6]/60 dark:border-[#273244] dark:bg-[#0f172a]/35 md:block">
              <Table className="w-full min-w-[900px] table-fixed sm:min-w-0 xl:min-w-full">
                <TableHeader className="sticky top-0 z-10 bg-[#fffdfa]/95 text-[11px] font-semibold text-[#1c1917] dark:bg-[#111827]/95 dark:text-[#f8fafc]">
                  <TableRow>
                      ...
                      {editingOrden && (
                        <div>
                          ...
                          <input
                            ...
                            className="w-full h-10 rounded-lg border border-gray-300 dark:border-[#334155] bg-white dark:bg-[#0f172a] text-sm px-3 shadow-theme-xs text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:border-[#ff801f] focus:ring-2 focus:ring-[#ff801f]/20 outline-none"
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        {(formData.cliente_id || formData.cliente) && (
                          <button
                            ...
                            className="shrink-0 h-10 w-10 inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-600 shadow-theme-xs hover:bg-gray-50 dark:border-[#334155] dark:bg-[#0f172a] dark:text-gray-200 dark:hover:bg-white/5 transition mt-[20px]"
                          >
                            <svg
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            ...
                            className={`shrink-0 inline-flex h-10 w-10 items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-600 shadow-theme-xs hover:bg-gray-50 dark:border-[#334155] dark:bg-[#0f172a] dark:text-gray-200 dark:hover:bg-white/5 ${!formData.telefono_cliente ? 'opacity-50 pointer-events-none' : ''}`}
                            title="Llamar"
                            aria-label="Llamar"
                          >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2 py-1 text-[11px] font-medium text-[#ff801f] dark:text-[#ffa057] hover:text-[#ff6a00] dark:hover:text-[#ffb074] transition-colors"
                          >
                            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <div className="relative">
                          <textarea
                            ...
                            rows={2}
                            className="w-full rounded-lg border border-gray-300 dark:border-[#334155] bg-white dark:bg-[#0f172a] text-sm px-3 py-2 pr-12 shadow-theme-xs text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:border-[#ff801f] focus:ring-2 focus:ring-[#ff801f]/20 outline-none resize-none"
                          ...
                          {formData.direccion && (
                            <button
                              ...
                              className="absolute top-1/2 -translate-y-1/2 right-2 p-1.5 rounded-md bg-[#ff801f]/10 dark:bg-[#ff801f]/20 text-[#ff801f] dark:text-[#ffa057] hover:bg-[#ff801f]/20 dark:hover:bg-[#ff801f]/30 transition-colors"
                    ...
                    <div className="space-y-4 rounded-xl border border-[#e7ded0] bg-[#fcfaf6] p-4 shadow-theme-xs dark:border-[#334155] dark:bg-[#0f172a]/80">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full rounded-lg border border-gray-300 dark:border-[#334155] bg-white dark:bg-[#0f172a] text-sm px-3 py-2 shadow-theme-xs text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:border-[#ff801f] focus:ring-2 focus:ring-[#ff801f]/20 outline-none resize-none"
                        ...
                        {formData.servicios_realizados.map((servicio, index) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="hover:text-[#ff6a00] dark:hover:text-[#ffb074] ml-1"
                            >
                              ×
                            </button>
                          </span>
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="flex justify-center gap-3 pt-2">
                            <button
                              ...
                              className="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:border-[#334155] center dark:bg-[#0f172a] dark:text-gray-400 dark:hover:bg-white/5"
                            >
                              Cancelar
                            </button>
                            <button
