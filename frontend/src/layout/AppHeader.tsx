...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-99999 flex w-full border-b border-[#e7ded0] bg-[#f7f5f0]/90 backdrop-blur-md [font-family:'Arial','Helvetica_Neue',Helvetica,sans-serif] dark:border-[#273244] dark:bg-[#0b1018]/85">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div
          ...
          } w-full items-center justify-between gap-4 bg-[#f7f5f0] px-5 py-4 dark:bg-[#0b1018] lg:flex lg:justify-end lg:bg-transparent lg:px-0`}
        >
